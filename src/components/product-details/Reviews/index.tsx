...
const overallStatistcsItems: OverallStasticType[] = [
    {
        label: RatingCategorysEnum.Delivery,
        rating: 5,
        statistic: 56,
    },
    {
        label: RatingCategorysEnum.CustomerService,
        rating: 4,
        statistic: 65,
    },
    {
        label: RatingCategorysEnum.Design,
        rating: 4,
        statistic: 21,
    },
    {
        label: RatingCategorysEnum.SizeAndFit,
        rating: 4,
        statistic: 21,
    },
    {
        label: RatingCategorysEnum.Comfort,
        rating: 4,
        statistic: 21,
    },
];

const StarsStatistics: { title: number; value: number }[] = _.rangeRight(1, 6).map((title) => ({
    title,
    value: title * 18,
...
const Reviews = () => {
    return (
        <div className="py-5  border-gray-100">
            ...
            <div className="grid md:grid-cols-[300px,auto] gap-4">
                <div className="bg-white p-4 shadow-sm border border-gray-100 rounded-xl h-fit">
                    <h5 className="text-lg font-semibold mb-4">Overall</h5>
                    <div className="flex gap-5 items-center">
                        <div className="flex-shrink-0 text-center">
                            <span className="text-7xl font-semibold mb-2 block">4.5</span>
                            <MultipleStarsRating
                                value={4.5}
                                starsClassName="text-sm"
                                className="justify-center mb-0.5"
                            />
                            <p className="text-secondaryText text-sm">220 customers</p>
                        </div>
                        <div className="flex-grow">
                            <ul className="space-y-2">
                                {StarsStatistics.map((item) => (
                                    <li key={v4()} className="flex items-center space-x-2">
                    ...
                    <ul className="flex flex-col space-y-2">
                        {overallStatistcsItems.map((item) => (
                            <StatisticItem
                                key={v4()}
                                label={item.label}
                                rating={item.rating}
                ...
                <div className="p-4   h-fit">
                    <TitleHeader title="Ratings" isH6 className="mb-5">
                        <ShowingTotal showing={45} total={50} />
                    </TitleHeader>
